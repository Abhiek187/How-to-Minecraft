...
plugins {
    ...
    `maven-publish`
    idea
    id("net.neoforged.moddev") version "2.0.107" // ModDevGradle
...
neoForge {
    ...
    unitTest {
        ...
        testedMod = mods.named(modId) // <mod name> must match the name in the mods { } block.
...
// A missing property will result in an error. Properties are expanded using ${} Kotlin notation.
